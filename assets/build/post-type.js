...
const MainTabs = () => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Flex, {
    ...
    className: "logo",
    href: MBCPT.url
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_logo_svg__WEBPACK_IMPORTED_MODULE_9__.ReactComponent, null))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, MBCPT.action == 'add' ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Add Post Type', 'mb-custom-post-type') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Edit Post Type', 'mb-custom-post-type')), !(MBCPT.action == 'add') && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
...
const AdvancedControls = [{
  ...
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Controls how the type is visible to authors and readers.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Whether a post type is intended for use publicly either via the admin interface or by front-end users', 'mb-custom-post-type')
}, {
  type: 'checkbox',
  name: 'hierarchical',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Hierarchical', 'mb-custom-post-type'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Whether the post type is hierarchical.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Whether the post type is hierarchical (e.g. page)', 'mb-custom-post-type')
}, {
  type: 'checkbox',
  ...
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Where to show the post type in the admin menu. Show UI must be enabled.', 'mb-custom-post-type'),
  options: MBCPT.show_in_menu_options,
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Where to show the post type in the admin menu', 'mb-custom-post-type')
}, {
  type: 'select',
  name: 'menu_position',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Menu position after', 'mb-custom-post-type'),
  options: MBCPT.menu_position_options,
  dependency: 'show_in_menu:true',
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The position in the menu order the post type should appear', 'mb-custom-post-type')
}, {
  type: 'select',
  name: 'icon_type',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Icon type', 'mb-custom-post-type'),
  options: MBCPT.icon_type,
  dependency: 'show_in_menu:true'
}, {
  type: 'icon',
  name: 'icon',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Icon', 'mb-custom-post-type'),
  dependency: 'icon_type:dashicons',
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The icon to be used for the admin menu (Dashicons)', 'mb-custom-post-type')
}, {
  type: 'text',
  name: 'icon_svg',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Icon SVG', 'mb-custom-post-type'),
  ...
  type: 'text',
  name: 'icon_custom',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Icon URL', 'mb-custom-post-type'),
  dependency: 'icon_type:custom'
}, {
  type: 'fontawesome',
  name: 'font_awesome',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Icon', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The icon to be used for the admin menu (FontAwesome)', 'mb-custom-post-type'),
  ...
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Whether to expose this post type in the REST API. Must be true to enable the Gutenberg editor.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Whether to include the post type in the REST API. Set this to true for the post type to be available in the block editor', 'mb-custom-post-type')
}, {
  type: 'text',
  name: 'rest_base',
