...
/***/ "./app/controls/TokenFieldSelect.js":
/*!******************************************!*\
  !*** ./app/controls/TokenFieldSelect.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TokenFieldSelect);
...
/* harmony import */ var _controls_Control__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../controls/Control */ "./app/controls/Control.js");
/* harmony import */ var _controls_TokenFieldSelect__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../controls/TokenFieldSelect */ "./app/controls/TokenFieldSelect.js");
...
const tabs = [{
  ...
  name: 'permissions',
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Permissions', 'mb-custom-post-type')
}, {
  name: 'features',
...
const panels = {
  general: [..._constants_Data__WEBPACK_IMPORTED_MODULE_11__.BasicControls.map((field, key) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_Control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: key,
    field: field,
    autoFills: autoFills.filter(f => f.updateFrom === field.name)
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_TokenFieldSelect__WEBPACK_IMPORTED_MODULE_8__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Associated post types', 'mb-custom-post-type'),
    validateTokens: token => Object.keys(MBCPT.types).includes(token),
    name: "types",
    suggestions: Object.keys(MBCPT.types),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Select post types', 'mb-custom-post-type')
  })],
  labels: _constants_Data__WEBPACK_IMPORTED_MODULE_11__.LabelControls.map((field, key) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_Control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: key,
    field: field
  })),
  advanced: _constants_Data__WEBPACK_IMPORTED_MODULE_11__.AdvancedControls.map((field, key) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_Control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: key,
    field: field
  })),
  permissions: _constants_Data__WEBPACK_IMPORTED_MODULE_11__.PermissionsControls.map((field, key) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_Control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: key,
    field: field
  })),
  features: _constants_Data__WEBPACK_IMPORTED_MODULE_11__.FeatureControls.map((field, key) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_Control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: key,
    field: field
  })),
  code: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, _constants_Data__WEBPACK_IMPORTED_MODULE_11__.CodeControls.map((field, key) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_Control__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: key,
    field: field
...
const MainTabs = () => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Flex, {
    ...
    href: MBCPT.url
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_logo_svg__WEBPACK_IMPORTED_MODULE_9__.ReactComponent, null))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, MBCPT.action === 'add' ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Add Taxonomies', 'mb-custom-post-type') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Edit Taxonomies', 'mb-custom-post-type'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Flex, {
    gap: 1,
    expanded: false
...
/* harmony export */   PermissionsControls: () => (/* binding */ PermissionsControls)
/* harmony export */ });
...
const BasicControls = [{
  ...
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Whether the taxonomy is hierarchical (e.g. like category).', 'mb-custom-post-type')
}];
const CodeControls = [{
  type: 'text',
  name: 'function_name',
...
const PermissionsControls = [{
  type: 'text',
  name: 'capabilities.manage_terms',
  placeholder: 'manage_categories',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Manage terms', 'mb-custom-post-type'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for managing terms.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for managing terms.', 'mb-custom-post-type'),
  datalist: MBCPT.allCapabilities
}, {
  type: 'text',
  name: 'capabilities.edit_terms',
  placeholder: 'manage_categories',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Edit terms', 'mb-custom-post-type'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for editing terms.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for editing terms.', 'mb-custom-post-type'),
  datalist: MBCPT.allCapabilities
}, {
  type: 'text',
  name: 'capabilities.delete_terms',
  placeholder: 'manage_categories',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Delete terms', 'mb-custom-post-type'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for deleting terms.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for deleting terms.', 'mb-custom-post-type'),
  datalist: MBCPT.allCapabilities
}, {
  type: 'text',
  name: 'capabilities.assign_terms',
  placeholder: 'edit_posts',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Assign terms', 'mb-custom-post-type'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for assigning terms.', 'mb-custom-post-type'),
  tooltip: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The capability required for assigning terms.', 'mb-custom-post-type'),
  datalist: MBCPT.allCapabilities
}];
const FeatureControls = [{
  type: 'toggle',
  name: 'order',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Re-Order Terms', 'mb-custom-post-type'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Order terms of this taxonomy using a drag and drop interface.', 'mb-custom-post-type')
}];
...
/* harmony import */ var _DefaultSettings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DefaultSettings */ "./app/taxonomy/constants/DefaultSettings.js");
...
const special = settings => {
  return (0,_code__WEBPACK_IMPORTED_MODULE_1__.outputSettingObject)(settings, 'capabilities', 3);
};
...
const meta_box_cb = settings => {
  ...
  return `\r\t\t'meta_box_cb'${(0,_code__WEBPACK_IMPORTED_MODULE_1__.spaces)(settings, 'meta_box_cb')} => ${value},`;
};
const meta_box_sanitize_cb = settings => {
  ...
  return `\n\t\t'meta_box_sanitize_cb'${(0,_code__WEBPACK_IMPORTED_MODULE_1__.spaces)(settings, 'meta_box_sanitize_cb')} => '${settings.meta_box_sanitize_cb}',`;
};
const PhpCode = settings => {
  return `<?php
add_action( 'init', '${settings.function_name || _DefaultSettings__WEBPACK_IMPORTED_MODULE_2__["default"].function_name}' );
function ${settings.function_name || _DefaultSettings__WEBPACK_IMPORTED_MODULE_2__["default"].function_name}() {
	$labels = [
