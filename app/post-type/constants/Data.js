...
export const AdvancedDatas = [
	...
	{ type: 'checkbox', name: 'show_ui', label: __( 'Show UI?', 'mb-custom-post-type' ), description: __( 'Whether queries can be performed on the frontend.', 'mb-custom-post-type' ), checked: true },
	{ type: 'checkbox', name: 'show_in_nav_menus', label: __( 'Show in nav menus?', 'mb-custom-post-type' ), description: __( 'Whether queries can be performed on the frontend.', 'mb-custom-post-type' ), checked: true },
