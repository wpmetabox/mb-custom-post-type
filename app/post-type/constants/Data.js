...
export const LabelDatas = [
	// Name
	// Singular name
	{ type: 'text', name: 'labels.add_new', label: __( 'Add new', 'mb-custom-post-type' ), defaultValue: __( 'Add New', 'mb-custom-post-type' ) },
	{ type: 'text', name: 'labels.add_new_item', label: __( 'Add new item', 'mb-custom-post-type' ), defaultValue: __( 'Add new %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.edit_item', label: __( 'Edit item', 'mb-custom-post-type' ), defaultValue: __( 'Edit %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.new_item', label: __( 'New item', 'mb-custom-post-type' ), defaultValue: __( 'New %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.view_item', label: __( 'View item', 'mb-custom-post-type' ), defaultValue: __( 'View %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.view_items', label: __( 'View items', 'mb-custom-post-type' ), defaultValue: __( 'View %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.search_items', label: __( 'Search items', 'mb-custom-post-type' ), defaultValue: __( 'Search %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.not_found', label: __( 'Not found', 'mb-custom-post-type' ), defaultValue: __( 'No %name% found', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.not_found_in_trash', label: __( 'Not found in trash', 'mb-custom-post-type' ), defaultValue: __( 'No %name% found in Trash', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.parent_item_colon', label: __( 'Parent items', 'mb-custom-post-type' ), defaultValue: __( 'Parent %singular_name%:', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.all_items', label: __( 'All items', 'mb-custom-post-type' ), defaultValue: __( 'All %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.archives', label: __( 'Nav menus archives', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% Archives', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.attributes', label: __( 'Attributes meta box', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% Attributes', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.insert_into_item', label: __( 'Media frame button', 'mb-custom-post-type' ), defaultValue: __( 'Insert into %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.uploaded_to_this_item', label: __( 'Media frame filter', 'mb-custom-post-type' ), defaultValue: __( 'Uploaded to this %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.featured_image', label: __( 'Featured image meta box', 'mb-custom-post-type' ), defaultValue: __( 'Featured image', 'mb-custom-post-type' ) },
	{ type: 'text', name: 'labels.set_featured_image', label: __( 'Setting the featured image', 'mb-custom-post-type' ), defaultValue: __( 'Set featured image', 'mb-custom-post-type' ) },
	{ type: 'text', name: 'labels.remove_featured_image', label: __( 'Removing the featured image', 'mb-custom-post-type' ), defaultValue: __( 'Remove featured image', 'mb-custom-post-type' ) },
	{ type: 'text', name: 'labels.use_featured_image', label: __( 'Used as featured image', 'mb-custom-post-type' ), defaultValue: __( 'Use as featured image', 'mb-custom-post-type' ) },
	{ type: 'text', name: 'labels.menu_name', label: __( 'Menu name', 'mb-custom-post-type' ), defaultValue: __( '%name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.filter_items_list', label: __( 'Table views hidden heading', 'mb-custom-post-type' ), defaultValue: __( 'Filter %name% list', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.items_list_navigation', label: __( 'Table pagination hidden heading', 'mb-custom-post-type' ), defaultValue: __( '%name% list navigation', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.items_list', label: __( 'Table hidden heading', 'mb-custom-post-type' ), defaultValue: __( '%name% list', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.item_published', label: __( 'Item published', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% published', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.item_published_privately', label: __( 'Item published with private visibility', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% published privately', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.item_reverted_to_draft', label: __( 'Item switched to draft', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% reverted to draft', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.item_scheduled', label: __( 'Item scheduled', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% scheduled', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.item_updated', label: __( 'Item updated', 'mb-custom-post-type' ), defaultValue: __( '%singular_name% updated', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
];
...
export const AdvancedDatas = [
	...
	{ type: 'checkbox', name: 'rewrite.with_front', label: __( 'Prepended permalink structure', 'mb-custom-post-type' ), description: __( 'Whether the permastruct should be prepended with <code>WP_Rewrite::$front</code>', 'mb-custom-post-type' ), checked: true },
