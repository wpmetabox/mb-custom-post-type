...
export const BasicDatas = [
	...
	{ type: 'text', name: 'slug', label: __( 'Slug', 'mb-custom-post-type' ), required: true, updateFrom: 'labels.singular_name', tooltip: __( 'Post type key. Must not exceed 20 characters and may only contain lowercase alphanumeric characters, dashes, and underscores', 'mb-custom-post-type' ) },
];
...
export const AdvancedDatas = [
	...
	{ type: 'radio', name: 'capability_type', label: __( 'Capability type', 'mb-custom-post-type' ), description: __( 'The post type to use for checking read, edit, and delete capabilities.', 'mb-custom-post-type' ), options: CapabilityDatas, default: 'post', tooltip: __( 'The string to use to build the read, edit, and delete capabilities', 'mb-custom-post-type' ) },
	// map_meta_cap
	// supports
	// taxonomies
