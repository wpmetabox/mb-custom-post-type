...
export const LabelDatas = [
	...
	{ type: 'text', name: 'labels.filter_items_list', label: __( 'Table filter hidden heading', 'mb-custom-post-type' ), default: __( 'Filter %name% list', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.filter_by_date', label: __( 'Table date filter hidden heading', 'mb-custom-post-type' ), default: __( 'Filter by date', 'mb-custom-post-type' ) },
	...
	{ type: 'text', name: 'labels.item_published_privately', label: __( 'Item published privately', 'mb-custom-post-type' ), default: __( '%singular_name% published privately', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
