...
export const BasicControls = [
	...
	},
	{
		...
		description: __( 'Whether a post type is intended for use publicly either via the admin interface or by front-end users.', 'mb-custom-post-type' ),
	},
	{
		type: 'checkbox',
		name: 'hierarchical',
		label: __( 'Hierarchical', 'mb-custom-post-type' ),
		description: __( 'Whether the post type is hierarchical (e.g. like page).', 'mb-custom-post-type' ),
	},
	{
		type: 'checkbox',
		name: 'show_in_rest',
	...
	},
	{
		type: 'select',
		name: 'show_in_menu',
		label: __( 'Show in admin menu', 'mb-custom-post-type' ),
		options: MBCPT.show_in_menu_options,
	},
	{
		type: 'select',
		name: 'menu_position',
		label: __( 'Show post type menu after', 'mb-custom-post-type' ),
	...
	},
	{
		type: 'select',
		name: 'icon_type',
		label: __( 'Menu icon type', 'mb-custom-post-type' ),
	...
	},
	{
		type: 'icon',
		name: 'icon',
		label: __( 'Menu icon', 'mb-custom-post-type' ),
		dependency: 'show_in_menu:true && icon_type:dashicons',
	},
	{
		type: 'text',
		name: 'icon_svg',
		label: __( 'Menu icon SVG', 'mb-custom-post-type' ),
	...
	},
	{
		type: 'text',
		name: 'icon_custom',
		label: __( 'Menu icon URL', 'mb-custom-post-type' ),
