...
export const AdvancedDatas = [
	...
	{ type: 'checkbox', name: 'public', label: __( 'Public', 'mb-custom-post-type' ), description: __( 'Whether a taxonomy is intended for use publicly either via the admin interface or by front-end users.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'publicly_queryable', label: __( 'Public queryable', 'mb-custom-post-type' ), description: __( 'Whether the taxonomy is publicly queryable.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'hierarchical', label: __( 'Hierarchical', 'mb-custom-post-type' ), description: __( 'Whether the taxonomy is hierarchical.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'show_ui', label: __( 'Show UI', 'mb-custom-post-type' ), description: __( 'Whether to generate and allow a UI for managing terms in this taxonomy in the admin.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'show_in_menu', label: __( 'Show in menu', 'mb-custom-post-type' ), description: __( 'Whether to show the taxonomy in the admin menu.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'show_in_nav_menus', label: __( 'Show in nav menus', 'mb-custom-post-type' ), description: __( 'Makes this taxonomy available for selection in navigation menus.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'meta_box_cb', label: __( 'Show on edit page', 'mb-custom-post-type' ), description: __( 'Whether to show the taxonomy on the edit page.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'show_in_rest', label: __( 'Show in REST', 'mb-custom-post-type' ), description: __( 'Whether to include the taxonomy in the REST API. Must be true to enable the Gutenberg editor.', 'mb-custom-post-type' ) },
	...
	{ type: 'checkbox', name: 'show_tagcloud', label: __( 'Show tag cloud', 'mb-custom-post-type' ), description: __( 'Whether to list the taxonomy in the Tag Cloud Widget controls.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'show_in_quick_edit', label: __( 'Show in quick edit', 'mb-custom-post-type' ), description: __( 'Whether to show the taxonomy in the quick/bulk edit panel.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'show_admin_column', label: __( 'Show admin column', 'mb-custom-post-type' ), description: __( 'Whether to display a column for the taxonomy on its post type listing screens.', 'mb-custom-post-type' ) },
	...
	{ type: 'checkbox', name: 'rewrite.hierarchical', label: __( 'Hierarchical URL', 'mb-custom-post-type' ), description: __( 'Either hierarchical rewrite tag or not', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'query_var', label: __( 'Query var', 'mb-custom-post-type' ), description: __( 'Uncheck to disable the query var, check to use the taxonomy\'s "name" as query var.', 'mb-custom-post-type' ) },
	{ type: 'checkbox', name: 'sort', label: __( 'Sort', 'mb-custom-post-type' ), description: __( 'Whether this taxonomy should remember the order in which terms are added to objects.', 'mb-custom-post-type' ) },
];