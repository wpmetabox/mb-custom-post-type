...
export const LabelDatas = [
	...
	{ type: 'text', name: 'labels.popular_items', label: __( 'Popular items', 'mb-custom-post-type' ), defaultValue: __( 'Popular %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	...
	{ type: 'text', name: 'labels.parent_item', label: __( 'Parent item', 'mb-custom-post-type' ), defaultValue: __( 'Parent %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.parent_item_colon', label: __( 'Parent item colon', 'mb-custom-post-type' ), defaultValue: __( 'Parent %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	...
	{ type: 'text', name: 'labels.update_item', label: __( 'Update item', 'mb-custom-post-type' ), defaultValue: __( 'Update %singular_name%', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	...
	{ type: 'text', name: 'labels.new_item_name', label: __( 'New item name', 'mb-custom-post-type' ), defaultValue: __( 'New %singular_name% name', 'mb-custom-post-type' ), updateFrom: 'labels.singular_name' },
	{ type: 'text', name: 'labels.separate_items_with_commas', label: __( 'Separate items with commas', 'mb-custom-post-type' ), defaultValue: __( 'Separate %name% with commas', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.add_or_remove_items', label: __( 'Add or remove items', 'mb-custom-post-type' ), defaultValue: __( 'Add or remove %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.choose_from_most_used', label: __( 'Choose from most used', 'mb-custom-post-type' ), defaultValue: __( 'Choose most used %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	...
	{ type: 'text', name: 'labels.no_terms', label: __( 'No terms', 'mb-custom-post-type' ), defaultValue: __( 'No %name% found', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.items_list_navigation', label: __( 'Table pagination hidden heading', 'mb-custom-post-type' ), defaultValue: __( '%name% list pagination', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	...
	{ type: 'text', name: 'labels.most_used', label: __( 'Most used tab', 'mb-custom-post-type' ), defaultValue: __( 'Most Used', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
	{ type: 'text', name: 'labels.back_to_items', label: __( 'Back to items', 'mb-custom-post-type' ), defaultValue: __( 'Back to %name%', 'mb-custom-post-type' ), updateFrom: 'labels.name' },
...
export const AdvancedDatas = [
	...
	{ type: 'checkbox', name: 'rewrite.with_front', label: __( 'With front', 'mb-custom-post-type' ), description: __( 'Should the permastruct be prepended with <code>WP_Rewrite::$front</code>', 'mb-custom-post-type' ), checked: false },
